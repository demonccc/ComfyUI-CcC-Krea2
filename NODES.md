...
- `subject_transfer_1` / `subject_transfer_2`: BFS-aligned `body_swap:` prompt that transfers the complete Subject with its clothing and accessories, while matching the Scene character's exact position, pose, action, role, and interactions.
