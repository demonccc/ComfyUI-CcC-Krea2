...
- Visual edit reference latents, fit flags, boosts, and CcC RoPE placement now travel through CONDITIONING instead of being captured inside a MODEL-wrapper closure, matching the proven RedNode/Identity Edit transport contract.
