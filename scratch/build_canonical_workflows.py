...
def main():
    ...
    subject_transfer_note = (
        ...
        "• Easy Visual References: Subject and Outfit use contain_no_upscale; Scene and combined Scene+Outfit use contain. No appearance reference is destructively cropped.\n"
